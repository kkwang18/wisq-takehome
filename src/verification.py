...
def build_verification_prompt(draft: str, cited_chunks: list[Chunk]) -> str:
    ...
    return (
        ...
        "Also note three specific reasoning patterns that are valid, supported inferences from "
        "the excerpts, not unsupported claims — do not flag any of them as UNSUPPORTED merely "
